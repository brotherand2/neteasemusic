...
@property(strong, nonatomic) NMSongUrlInfo *playUrlInfo; // @synthesize playUrlInfo=_playUrlInfo;
...
@interface NMPlayListDetailViewController :UIViewController
@property(readonly, nonatomic) NSMutableArray *songArray;
@end
...
+ (void)fixFMPlayUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3;
+ (void)fixFMUrlInfo:(id)arg1 completeBlock:(id)arg2;
+ (void)fixSongDownloadUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3;
+ (void)fixSongPlayUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3;
+ (void)fixSongUrlInfo:(id)arg1 type:(long long)arg2 completeBlock:(id)arg3;
...
- (void)_fixFMUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3 retryCount:(long long)arg4;
- (void)_fixFMUrlInfo:(id)arg1 completeBlock:(id)arg2;
- (void)_fixSongDownloadUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3 retryCount:(long long)arg4;
- (void)_fixSongPlayUrlInfo:(id)arg1 bitrate:(long long)arg2 completeBlock:(id)arg3 retryCount:(long long)arg4;
- (void)_fixSongUrlInfo:(id)arg1 type:(long long)arg2 completeBlock:(id)arg3;
...
@end
@interface NMSettingIconAndSwitchCell : UIView
